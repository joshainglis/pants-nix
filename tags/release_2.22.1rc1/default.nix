...
let
  ...
  version = "2.22.1rc1";
  hash = "sha256-T6sarDTq6FsdDO5n09rYPZC3r0g6je88yDTSjAa+P5Q=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.22.1rc1/src/rust/engine/rust-toolchain
  rustVersion = "1.78.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.22.1rc1/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
