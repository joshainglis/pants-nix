...
let
  ...
  version = "2.23.0rc0";
  hash = "sha256-k33mZiC4+y4tuY1KU9u97PAKtY0p4hnhceXUWyG6Mio=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.23.0rc0/src/rust/engine/rust-toolchain
  rustVersion = "1.81.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.23.0rc0/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
