...
let
  ...
  version = "2.24.0.dev1";
  hash = "sha256-mOsGmdUt0JN6Ks17AA5FV4qR9ezjco5xxEbMXy9Uuzc=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.24.0.dev1/src/rust/engine/rust-toolchain
  rustVersion = "1.81.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.24.0.dev1/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
