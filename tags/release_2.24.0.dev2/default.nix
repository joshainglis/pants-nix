...
let
  ...
  version = "2.24.0.dev2";
  hash = "sha256-Aibz/dzJUPcDTY/xNTJdyksVS6ynh37vFVsFT57Ayoc=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.24.0.dev2/src/rust/engine/rust-toolchain
  rustVersion = "1.81.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.24.0.dev2/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
